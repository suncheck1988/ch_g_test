    ...
    'config' => [
        'doctrine' => [
            ...
            'types' => [
                ...
                App\Data\Doctrine\Type\Wallet\TransactionStatusType::class,
                App\Data\Doctrine\Type\Wallet\TransactionTypeType::class,
                App\Data\Doctrine\Type\Wallet\WalletOwnerTypeType::class,
                App\Data\Doctrine\Type\Wallet\WalletTypeType::class,
            ],
        ],
    ],
];
